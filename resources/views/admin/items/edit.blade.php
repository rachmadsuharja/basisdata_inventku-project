    ...
    <!-- page-header -->
        <div class="page-header">
            <ol class="breadcrumb breadcrumb-arrow mt-3">
                ...
                <li class="active"><span>Edit Barang</span></li>
            </ol>
        </div>
                ...
                <div class="card overflow-hidden">
                    <form action="{{ route('items.update', $item->id) }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="card-header">
                            <div>
                                <h3 class="card-title">Edit Barang Anda</h3>
                            </div>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('code') is-invalid state-invalid @enderror" id="code" name="code" placeholder="Kode Barang" value="{{ $item->code }}">
                                        @error('code')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('name') is-invalid state-invalid @enderror" id="name" name="name" placeholder="Nama Barang" value="{{ $item->name }}">
                                        @error('name')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col">
                                            <div class="form-group">
                                                ...
                                                <input type="number" class="form-control @error('stock') is-invalid state-invalid @enderror" id="stock" name="stock" placeholder="Stok Barang" value="{{ $item->stock }}">
                                                @error('stock')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control @error('unit') is-invalid state-invalid @enderror" id="unit" name="unit" placeholder="Satuan Barang" value="{{ $item->unit }}">
                                                @error('unit')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="row gutters-sm">
                                            <div class="col">
                                                <input type="text" class="form-control @error('price') is-invalid state-invalid @enderror" id="price" name="price" placeholder="Harga Barang (Rupiah)" value="{{ $item->price }}">
                                                @error('price')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="file" class="dropify form-control @error('image') is-invalid state-invalid @enderror" name="image" id="image" data-default-file="{{ asset('storage/items/'.$item->image) }}">
                                        @error('image')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <textarea name="item_description" id="item_description" rows="8" class="form-control" placeholder="Deskripsi Barang ...">{{ $item->item_description }}</textarea>
                                </div>
                            </div>
                        </div>
