...
<head>
  ...
  <title>InventKu</title>
  <meta content="" name="description">
  <meta content="" name="keywords">

  <!-- Favicons -->
  <link href="{{ asset('templates/herobiz/img/favicon.png') }}" rel="icon">
  <link href="{{ asset('templates/herobiz/img/apple-touch-icon.png') }}" rel="apple-touch-icon">
  ...
  <!-- Vendor CSS Files -->
  <link href="{{ asset('templates/herobiz/vendor/bootstrap/css/bootstrap.min.css') }}" rel="stylesheet">
  <link href="{{ asset('templates/herobiz/vendor/bootstrap-icons/bootstrap-icons.css') }}" rel="stylesheet">
  <link href="{{ asset('templates/herobiz/vendor/aos/aos.css') }}" rel="stylesheet">
  <link href="{{ asset('templates/herobiz/vendor/glightbox/css/glightbox.min.css') }}" rel="stylesheet">
  <link href="{{ asset('templates/herobiz/vendor/swiper/swiper-bundle.min.css') }}" rel="stylesheet">

  <!-- Variables CSS Files. Uncomment your preferred color scheme -->
  <link href="{{ asset('templates/herobiz/css/variables.css') }}" rel="stylesheet">
  ...
  <link href="{{ asset('templates/herobiz/css/main.css') }}" rel="stylesheet">
...
<body>
  ...
  <header id="header" class="header fixed-top" data-scrollto-offset="0">
    <div class="container-fluid d-flex align-items-center justify-content-between">
      ...
      <a href="index.html" class="logo d-flex align-items-center scrollto me-auto me-lg-0">
        ...
        <h1 class="hero-title">Invent<span class="text-primary">Ku</span></h1>
      </a>

      <nav id="navbar" class="navbar">
        <ul>
          <li><a class="nav-link scrollto {{ (Request::routeIs('welcome') && Request::is('#hero-animared')) ? 'active' : '' }}" href="{{ route('welcome') }}">Home</a></li>
          <li><a class="nav-link scrollto {{ (Request::routeIs('welcome') && Request::is('#about')) ? 'active' : '' }}" href="{{ route('welcome') }}#about">Tentang Kami</a></li>
  ...
  <section id="hero-animated" class="hero-animated d-flex align-items-center">
    <div class="container d-flex flex-column justify-content-center align-items-center text-center position-relative" data-aos="zoom-out">
      <img src="{{ ('hero-image.png') }}" class="img-fluid animated">
      <h2>Selamat Datang di <span class="fw-semibold">InventKu</span></h2>
      <p>Solusi Inventaris Modern untuk Meningkatkan Produktivitas Bisnis Anda</p>
      <div class="d-flex">
        <button class="btn btn-get-started" data-bs-toggle="modal" data-bs-target="#requestItems">Ajukan Permintaan</button>
        <a href="{{ route('welcome') }}#about" class="btn-watch-video d-flex align-items-center"><i class="bi bi-building"></i><span>Tentang Kami</span></a>
      </div>
    </div>
  </section>
...
{{--
  ...
  <!-- Vendor JS Files -->
  <script src="{{ asset('templates/herobiz/vendor/bootstrap/js/bootstrap.bundle.min.js') }}"></script>
  <script src="{{ asset('templates/herobiz/vendor/aos/aos.js') }}"></script>
  <script src="{{ asset('templates/herobiz/vendor/glightbox/js/glightbox.min.js') }}"></script>
  <script src="{{ asset('templates/herobiz/vendor/isotope-layout/isotope.pkgd.min.js') }}"></script>
  <script src="{{ asset('templates/herobiz/vendor/swiper/swiper-bundle.min.js') }}"></script>
  <script src="{{ asset('templates/herobiz/vendor/php-email-form/validate.js') }}"></script>

  <!-- Template Main JS File -->
  <script src="{{ asset('templates/herobiz/js/main.js') }}"></script>
